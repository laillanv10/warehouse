...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Jul 2021 pada 08.50
...
INSERT INTO `berita_acara` (`id`, `tanggal`, `no_container`, `nama_kapal`, `tgl_datang`, `konsolidator`, `importir`, `no_bl`, `jumlah`, `jenis_barang`, `weight`, `kubikasi`, `keterangan`) VALUES
...
CREATE TABLE `log_stripping` (
  ...
  `nama_kapal` varchar(128) NOT NULL,
  `konsolidator` varchar(128) NOT NULL,
  `tgl_ob` datetime DEFAULT NULL,
  `tgl_masuk` datetime DEFAULT NULL,
  `no_mobil` varchar(128) DEFAULT NULL,
  `tanggal` date NOT NULL,
  `waktu_mulai` time DEFAULT NULL,
  `marking` int(11) NOT NULL,
  `pending1` time DEFAULT NULL,
  `pending2` time DEFAULT NULL,
  `waktu_akhir` time DEFAULT NULL,
  `jml_mekanik` int(11) NOT NULL,
  `jml_bl` int(11) NOT NULL,
  `jml_buruh` int(11) NOT NULL,
...
INSERT INTO `log_stripping` (`id`, `asal`, `no_container`, `seal`, `nama_kapal`, `konsolidator`, `tgl_ob`, `tgl_masuk`, `no_mobil`, `tanggal`, `waktu_mulai`, `marking`, `pending1`, `pending2`, `waktu_akhir`, `jml_mekanik`, `jml_bl`, `jml_buruh`, `keterangan`) VALUES
(1, 'JITC', 'PLFU2015678', 'ICARRY024729', 'ARICA BRIDGE', 'PT LOGISTICS INTERNATIONAL', '2021-07-14 13:40:00', '2021-07-15 13:40:00', 'B1234\r\n', '2021-07-01', '10:49:00', 0, NULL, NULL, '11:12:00', 0, 0, 0, 'selesai');
