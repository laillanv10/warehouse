...
$act    = $_GET['act'];
if($act == 'create'){
    $sql="INSERT INTO ".$table." (nama, tel, email, tempatlahir, tanggallahir, alamat,spesialisasi)
    VALUES ('".$_POST['nama']."', '".$_POST['tel']."', '".$_POST['email']."','".$_POST['tempatlahir']."', '".$_POST['tanggallahir']."', '".$_POST['alamat']."','".$_POST['spesialisasi']."')";
